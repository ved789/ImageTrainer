...
def train(path_to_data, batch_size, epochs, learning_rate, models_bucket_name):
    ...
    path_val_data = os.path.join(path_to_data, 'training') # validation
    path_eval_data = os.path.join(path_to_data, 'training') # evaluation
    ...
    optimizer = Adam(learning_rate=learning_rate)#1e-5
    ...
    print("Starting evaluation using model.evaluate")
...
if __name__ == "__main__":
    ...
    path_to_data = './data'
    train(path_to_data, args.batch_size, 2, args.learning_rate, args.models_bucket_name)
