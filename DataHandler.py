...
food_classes = ['broken_street_sign', 'damaged_bollard', 'damaged_street_light', 'pothole']
...
if __name__ == '__main__':
    ...
    path_to_train_data = './data/training/'
    path_to_val_data = './data/training/'
    path_to_eval_data = './data/training/'
    ...
    if list_blobs_switch:
        blobs = list_blobs('images-data-bucket')

        for blob in blobs:
            print(blob.name)

    if download_data_switch:
        download_data_to_local_directory("images-data-bucket", "./data")
